...
public class JFTipoProduto extends javax.swing.JFrame {
    static TipoProduto tbTpProd = new TipoProduto();
    //Creates new form JFProduto    
    public JFTipoProduto() {
        initComponents();
        tbTpProd.PreencherTabela(jtbInfoTpProd, true);
    }
    ...
    private void initComponents() {
        ...
        jtbInfoTpProd = new javax.swing.JTable();
        ...
        jtbInfoTpProd.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jtbInfoTpProd);
    ...
    private void jtbIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtbIncluirActionPerformed
        new JFMGerenciarTPProduto( true, 0, 2).setVisible(true);
        tbTpProd.PreencherTabela(jtbInfoTpProd, true);
    ...
    private void jtbAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtbAlterarActionPerformed
        if (jtbInfoTpProd.getSelectedRowCount() != 0 ){
            int linha = jtbInfoTpProd.getSelectedRow();
            Object ValorCampo = jtbInfoTpProd.getModel().getValueAt(linha, 0);
            int codTpProd = Integer.valueOf((String) ValorCampo);
            new JFMGerenciarTPProduto(true, codTpProd, 1).setVisible(true);
            tbTpProd.PreencherTabela(jtbInfoTpProd,true);
        }else{
    ...
    private void jtbExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtbExcluirActionPerformed
        if (jtbInfoTpProd.getSelectedRowCount() != 0 ){
            ...
            Object ValorCampo = jtbInfoTpProd.getModel().getValueAt(linha, 0);
            int codTpProd = Integer.valueOf((String) ValorCampo);
            new JFMGerenciarTPProduto( true, codTpProd, 3).setVisible(true);
            tbTpProd.PreencherTabela(jtbInfoTpProd, true);
        }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFTipoProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private static javax.swing.JTable jtbInfoTpProd;
