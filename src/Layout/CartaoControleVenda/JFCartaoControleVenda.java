...
public class JFCartaoControleVenda extends javax.swing.JFrame {
    static CartaoControleVenda tbCard = new CartaoControleVenda();
    //Creates new form JFProduto    
    public JFCartaoControleVenda() {
        initComponents();
        tbCard.PreencherTabela(jtbInfoCartao, true);
    }
    ...
    private void initComponents() {
        ...
        jtbInfoCartao = new javax.swing.JTable();
        ...
        jtbInfoCartao.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Codigo", "Ativo", "Dt. Cadastro"
            }
        ));
        jScrollPane1.setViewportView(jtbInfoCartao);
    ...
    private void jtbIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtbIncluirActionPerformed
        new JFMGerenciarCartaoControleVenda( true, 0, 2).setVisible(true);
        tbCard.PreencherTabela(jtbInfoCartao, true);
    ...
    private void jtbAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtbAlterarActionPerformed
        if (jtbInfoCartao.getSelectedRowCount() != 0 ){
            int linha = jtbInfoCartao.getSelectedRow();
            Object ValorCampo = jtbInfoCartao.getModel().getValueAt(linha, 0);
            int codCard = Integer.valueOf((String) ValorCampo);
            new JFMGerenciarCartaoControleVenda( true, codCard, 1).setVisible(true);
            tbCard.PreencherTabela(jtbInfoCartao,true);
        }else{
    ...
    private void jtbExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtbExcluirActionPerformed
        if (jtbInfoCartao.getSelectedRowCount() != 0 ){
            ...
            Object ValorCampo = jtbInfoCartao.getModel().getValueAt(linha, 0);
            int codCard = Integer.valueOf((String) ValorCampo);
            new JFMGerenciarCartaoControleVenda( true, codCard, 3).setVisible(true);
            tbCard.PreencherTabela(jtbInfoCartao, true);
        }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFCartaoControleVenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private static javax.swing.JTable jtbInfoCartao;
