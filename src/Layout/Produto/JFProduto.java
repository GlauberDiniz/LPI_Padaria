...
public class JFProduto extends javax.swing.JFrame {
    ...
    public JFProduto() {
        initComponents();
        tbProd.PreencherTabela(jtbInfoProdutos, true);
    }
    ...
    private void initComponents() {
        ...
        jtbInfoProdutos = new javax.swing.JTable();
        ...
        jtbInfoProdutos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Produto", "Descrição", "Tipo", "Vlr Compra", "Vlr Venda", "Fornecedor"
            }
        ));
        jScrollPane1.setViewportView(jtbInfoProdutos);
    ...
    private void jtbAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtbAlterarActionPerformed
        if (jtbInfoProdutos.getSelectedRowCount() != 0 ){
            int linha = jtbInfoProdutos.getSelectedRow();
            Object ValorCampo = jtbInfoProdutos.getModel().getValueAt(linha, 0);
    ...
    private static javax.swing.JTable jtbInfoProdutos;
