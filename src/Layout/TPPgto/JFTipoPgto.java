...
public class JFTipoPgto extends javax.swing.JFrame {
    static TipoPgto tbTpPgto = new TipoPgto();
    //Creates new form JFProduto    
    public JFTipoPgto() {
        initComponents();
        tbTpPgto.PreencherTabela(jtbInfoTpPgto, true);
    }
    ...
    private void jtbIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtbIncluirActionPerformed
        new JFMGerenciarTPPgto( true, 0, 2).setVisible(true);
        tbTpPgto.PreencherTabela(jtbInfoTpPgto, true);
    ...
    private void jtbAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtbAlterarActionPerformed
        if (jtbInfoTpPgto.getSelectedRowCount() != 0 ){
            ...
            new JFMGerenciarTPPgto( true, codTPPes, 1).setVisible(true);
            tbTpPgto.PreencherTabela(jtbInfoTpPgto,true);
        }else{
    ...
    private void jtbExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtbExcluirActionPerformed
        if (jtbInfoTpPgto.getSelectedRowCount() != 0 ){
            ...
            new JFMGerenciarTPPgto( true, codPes, 3).setVisible(true);
            tbTpPgto.PreencherTabela(jtbInfoTpPgto, true);
        }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFTipoPgto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
